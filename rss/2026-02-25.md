...
1. 阿里 发布Qwen3.5中量级全系模型
2. Claude Code 支持手机远程操控代码
3. Perplexity 升级Comet语音模式
4. Claude 发布企业级协作功能
5. Spotify 在多国上线AI提示词歌单
6. 谷歌 将ProducerAI纳入实验室
7. CastFox 结合Gemma 3n重塑播客

### 前沿研究

1. 字节Seed 利用化学思维提升推理能力
2. FARS系统 全自动快速产出百篇论文
3. 微软 研发出可存万年的玻璃存储
4. MIT 推出可制造的生成式3D框架
5. 能量溢出法 无需训练即可检测模型幻觉
6. JAEGER框架 让模型具备3D音视定位
7. Luna-2 显著降低模型评测成本
