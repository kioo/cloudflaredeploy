...
1. 谷歌发布Genie 3，支持文本图片生成虚拟世界，限美国用户测试。
2. 谷歌地图接入Gemini语音导航，支持语音查路况和代发短信。
3. 腾讯元宝派内测打通QQ音乐和视频，首次支持微信QQ好友同群。
4. 百度开源PaddleOCR-VL-1.5，首次实现异形框定位，登顶榜单。
5. ChatGPT旧模型2月13日下线，GPT-4o等将退役，API仍可用。

### 前沿研究

1. 人大微软清华发布LLM-in-Sandbox，让模型沙盒探索提升多领域能力。
2. 商汤开源MARS多模态模型，超越Gemini-3-Pro，支持动态视觉推理。
3. Anthropic研究显示AI编码辅助不一定提速，初学者能力可能受损。
