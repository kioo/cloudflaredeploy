...
1. Replit 发布 Agent 4 并推出新交互界面。
2. Perplexity API 升级为全栈开发平台。
3. Perplexity 发布主打隐私的本地 AI 电脑。
4. 谷歌 发布轻量模型 Gemini 3.1 Flash Lite。
5. Claude 推出办公插件更新并支持自动化。

### 前沿研究

1. ColQwen3.5 成为最强开源文档检索模型。
2. IDP 发布文档 AI 榜单且谷歌模型夺冠。
3. 研究人员 利用提示词解决稀有语言翻译难题。
4. LeCun 创办公司并获得 10 亿美元融资。

### 行业展望与社会影响

1. 黄仁勋 预测传统软件未来将演变为智能体。
2. 工信部 启动专项行动建设工业数据大模型。
